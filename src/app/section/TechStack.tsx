...
// const TechStack = () => {
//   return (
//     <section className="bg-[#fafaf9] relative">
//       <div className="grid grid-rows-2 justfy-center items-center">
//         <div className="grid grid-cols-3 row-start-1 ">
//           <div className="next row-start-1 col-span-1 col-start-2 flex justify-center items-center  h-[clamp(3rem,35vh,40rem)]">
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
//               fill="none"
//               viewBox="0 0 394 80"
...
//             </svg>
//           </div>
//           <div className="react row-start-1 col-span-1 col-start-1 flex justify-center items-center h-[clamp(3rem,35vh,40rem)]">
//             <svg
//               fill="#000"
//               width="150px"
//               height="150px"
...
//             </svg>
//           </div>
//           <div className="ts col-span-1 col-start-3 flex justify-center items-center h-[clamp(3rem,35vh,40rem)]">
//             <svg
//               width="150px"
//               height="150px"
//               viewBox="0 0 15 15"
...
//           </div>
//         </div>
//         <div className="grid grid-cols-4 row-start-2 justify-center items-center ">
//           <div className="next row-start-1 col-span-1 col-start-2 flex justify-center items-center  h-[clamp(3rem,35vh,40rem)]">
//             <svg
//               width="150px"
//               height="150px"
...
//             </svg>
//           </div>
//           <div className="css row-start-1 col-span-1 col-start-1 flex justify-center items-center h-[clamp(3rem,35vh,40rem)]">
//             <svg
//               width="150px"
//               height="150px"
//               viewBox="0 0 48 48"
...
//             </svg>
//           </div>
//           <div className="ts col-span-1 col-start-3 object-cover flex justify-center items-center h-[clamp(3rem,35vh,40rem)]">
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
//               viewBox="0 0 48 48"
//               width="150ppx"
...
//             </svg>
//           </div>
//           <div className="figma col-span-1 col-start-4 object-cover flex justify-center items-center h-[clamp(3rem,35vh,40rem)]">
//             <svg
//               width="150px"
//               height="150px"
//               viewBox="0 0 15 15"
