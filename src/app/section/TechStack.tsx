    ...
    <section className="descriptor bg-[#fafaf9] w-[80vw] relative py-20 w">
      ...
      <div ref={containerRef} className="relative w-[50vw] mx-auto mt-10">
        ...
        <div className="grid grid-cols-2 lg:hidden gap-0">
          ...
          <div className="tech-item flex items-center justify-center  border-b border-neutral-300 group cursor-pointer h-[clamp(75px,12.5vw,100px)] relative z-10">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 394 80"
          ...
          <div className="tech-item flex items-center justify-center border-r border-neutral-300 group cursor-pointer h-[clamp(75px,12.5vw,100px)] relative z-10">
            <svg
              width="40px"
              height="40px"
              viewBox="0 0 61 37"
          ...
          <div className="tech-item flex items-center justify-center border-neutral-300 group cursor-pointer h-[clamp(75px,12.5vw,100px)] relative z-10">
            <svg
              width="30px"
              height="30px"
              viewBox="0 0 15 15"
