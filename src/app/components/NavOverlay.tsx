  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-primary font-bold uppercase tracking-tight">Projects</h2>
      </Link>
       <Link
        href="#myjourney"
        onClick={(e) => handleLinkClick(e, "#myjourney")}
      ...
      >
        ...
        <h2 className="text-primary font-bold uppercase tracking-tight">The Journey</h2>
      </Link>
       <Link
        href="#contact"
      ...
      >
        ...
        <h2 className="text-primary font-bold uppercase tracking-tight">Contact</h2>
      </Link>
    </nav>
  );
};
